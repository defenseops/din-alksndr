...
app.use(helmet({
  ...
  contentSecurityPolicy: {
    directives: {
      ...
      frameSrc: ['https://www.youtube.com', 'https://youtube.com', 'https://disk.yandex.ru', 'https://disk.yandex.kz', 'https://yastatic.net'],
      connectSrc: ["'self'", 'https://mc.yandex.ru', 'wss://mc.yandex.ru', 'https://disk.yandex.ru', 'https://yastatic.net'],
      mediaSrc: ["'self'", 'https:'],
    },
  },
}));
